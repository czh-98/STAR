...
class CocoConverter(BaseConverter):
    ...
    def convert(self, dataset_path: str, out_path: str, enable_multi_human_data: bool = False) -> dict:
        """
        Args:
        ...
        json_path = os.path.join(dataset_path, "annotations", "person_keypoints_train2014.json")
