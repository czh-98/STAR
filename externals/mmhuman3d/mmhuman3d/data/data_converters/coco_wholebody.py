...
class CocoWholebodyConverter(BaseModeConverter):
    ...
    def convert_by_mode(self, dataset_path: str, out_path: str, mode: str) -> dict:
        ...
        json_path = os.path.join(dataset_path, "annotations", "coco_wholebody_{}_v1.0.json".format(mode))
        ...
        keypoints2d_, mask = convert_kps(keypoints2d_, "coco_wholebody", "human_data")
