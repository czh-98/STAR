...
class Pw3dHybrIKConverter(BaseConverter):
    ...
    def convert(self, dataset_path: str, out_path: str) -> dict:
        ...
        for ann_annotations in tqdm(database["annotations"]):
            ...
            f, c = np.array(imgs[image_id]["cam_param"]["focal"], dtype=np.float32), np.array(
            ...
            smpl["betas"].append(np.array(ann["smpl_param"]["shape"]).reshape((10)))
            smpl["thetas"].append(np.array(ann["smpl_param"]["pose"]).reshape((24, 3)))
