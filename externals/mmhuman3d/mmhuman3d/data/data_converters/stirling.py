...
class StirlingConverter(BaseModeConverter):
    ...
    def convert_by_mode(self, dataset_path: str, out_path: str, mode: str, img_quality: str) -> dict:
        """
        Args:
        ...
        keypoints3d, keypoints3d_mask = convert_kps(keypoints3d_, src="face3d", dst="human_data")
