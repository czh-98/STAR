...
class EftConverter(BaseModeConverter):
    ...
    def __init__(self, modes: List = []) -> None:
        ...
        self.json_mapping_dict = {
            "coco_all": ["coco_2014_train_fit/COCO2014-All-ver01.json", "train2014/"],
            "coco_part": ["coco_2014_train_fit/COCO2014-Part-ver01.json", "train2014/"],
    ...
    def convert_by_mode(
        ...
        if mode in self.json_mapping_dict.keys():
            annot_file = os.path.join(dataset_path, self.json_mapping_dict[mode][0])
