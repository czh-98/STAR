...
class CocoHybrIKConverter(BaseConverter):
    ...
    def convert(self, dataset_path: str, out_path: str) -> dict:
        ...
        # structs we need
        image_path_, keypoints2d_, bbox_xywh_, image_height_, image_width_, depth_factor_ = [], [], [], [], [], []

        # json annotation file
        json_path = os.path.join(dataset_path, "annotations", "person_keypoints_train2017.json")
