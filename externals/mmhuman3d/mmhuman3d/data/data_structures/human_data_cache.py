...
class HumanDataCacheReader:
    ...
    def get_item(self, index, required_keys: List[str] = []):
        ...
        for key in required_keys:
            ...
            if isinstance(non_sliced_value, dict) and key in base_data and isinstance(base_data[key], dict):
...
class HumanDataCacheWriter:
    ...
    def __init__(
        self, slice_size: int, data_len: int, keypoints_info: dict, non_sliced_data: dict, key_strict: bool = True
    ):
