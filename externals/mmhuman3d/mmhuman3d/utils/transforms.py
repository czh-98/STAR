...
try:
    ...
    warning_msg = stack_str + import_exception + "If pytorch3d is not required," + " this warning could be ignored."
...
class Compose:
    ...
    def __call__(self, rotation: Union[torch.Tensor, numpy.ndarray], convention: str = "xyz", **kwargs):
...
def ee_to_rotmat(
    euler_angle: Union[torch.Tensor, numpy.ndarray], convention="xyz"
...
def rotmat_to_ee(
    matrix: Union[torch.Tensor, numpy.ndarray], convention: str = "xyz"
) -> Union[torch.Tensor, numpy.ndarray]:
...
def rotmat_to_quat(matrix: Union[torch.Tensor, numpy.ndarray]) -> Union[torch.Tensor, numpy.ndarray]:
...
def rotmat_to_rot6d(matrix: Union[torch.Tensor, numpy.ndarray]) -> Union[torch.Tensor, numpy.ndarray]:
...
def quat_to_aa(quaternions: Union[torch.Tensor, numpy.ndarray]) -> Union[torch.Tensor, numpy.ndarray]:
...
def rot6d_to_rotmat(rotation_6d: Union[torch.Tensor, numpy.ndarray]) -> Union[torch.Tensor, numpy.ndarray]:
...
def aa_to_ee(
    axis_angle: Union[torch.Tensor, numpy.ndarray], convention: str = "xyz"
) -> Union[torch.Tensor, numpy.ndarray]:
...
def aa_to_rot6d(axis_angle: Union[torch.Tensor, numpy.ndarray]) -> Union[torch.Tensor, numpy.ndarray]:
...
def ee_to_aa(
    euler_angle: Union[torch.Tensor, numpy.ndarray], convention: str = "xyz"
) -> Union[torch.Tensor, numpy.ndarray]:
...
def ee_to_quat(euler_angle: Union[torch.Tensor, numpy.ndarray], convention="xyz") -> Union[torch.Tensor, numpy.ndarray]:
...
def rotmat_to_aa(matrix: Union[torch.Tensor, numpy.ndarray]) -> Union[torch.Tensor, numpy.ndarray]:
...
def quat_to_ee(
    quaternions: Union[torch.Tensor, numpy.ndarray], convention: str = "xyz"
) -> Union[torch.Tensor, numpy.ndarray]:
...
def quat_to_rot6d(quaternions: Union[torch.Tensor, numpy.ndarray]) -> Union[torch.Tensor, numpy.ndarray]:
...
def rot6d_to_aa(rotation_6d: Union[torch.Tensor, numpy.ndarray]) -> Union[torch.Tensor, numpy.ndarray]:
...
def rot6d_to_ee(
    rotation_6d: Union[torch.Tensor, numpy.ndarray], convention: str = "xyz"
) -> Union[torch.Tensor, numpy.ndarray]:
...
def make_homegeneous_rotmat_batch(input: torch.Tensor) -> torch.Tensor:
    ...
    padded_tensor = torch.cat([input, row_append.view(1, 1, 4).repeat(batch_size, 1, 1)], dim=1)
