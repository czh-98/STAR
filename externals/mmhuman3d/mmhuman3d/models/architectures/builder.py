...
ARCHITECTURES = Registry("architectures", parent=MMCV_MODELS, build_func=build_from_cfg)

ARCHITECTURES.register_module(name="HybrIK_trainer", module=HybrIK_trainer)
ARCHITECTURES.register_module(name="ImageBodyModelEstimator", module=ImageBodyModelEstimator)
ARCHITECTURES.register_module(name="VideoBodyModelEstimator", module=VideoBodyModelEstimator)
ARCHITECTURES.register_module(name="SMPLXImageBodyModelEstimator", module=SMPLXImageBodyModelEstimator)
ARCHITECTURES.register_module(name="CliffImageBodyModelEstimator", module=CliffImageBodyModelEstimator)
