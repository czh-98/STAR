...
class SMPLifyX(SMPLify):
    ...
    def __call__(
        ...
        left_hand_pose = self._match_init_batch_size(init_left_hand_pose, self.body_model.left_hand_pose, batch_size)
        right_hand_pose = self._match_init_batch_size(init_right_hand_pose, self.body_model.right_hand_pose, batch_size)
        expression = self._match_init_batch_size(init_expression, self.body_model.expression, batch_size)
        jaw_pose = self._match_init_batch_size(init_jaw_pose, self.body_model.jaw_pose, batch_size)
        leye_pose = self._match_init_batch_size(init_leye_pose, self.body_model.leye_pose, batch_size)
        reye_pose = self._match_init_batch_size(init_reye_pose, self.body_model.reye_pose, batch_size)
    ...
    def _set_keypoint_idxs(self):
        ...
        self.face_keypoint_idxs = get_keypoint_idxs_by_part("head", convention=convention)

        left_hand_keypoint_idxs = get_keypoint_idxs_by_part("left_hand", convention=convention)
        right_hand_keypoint_idxs = get_keypoint_idxs_by_part("right_hand", convention=convention)
        self.hand_keypoint_idxs = [*left_hand_keypoint_idxs, *right_hand_keypoint_idxs]

        self.body_keypoint_idxs = get_keypoint_idxs_by_part("body", convention=convention)
    ...
    def _get_weight(
        ...
        if use_shoulder_hip_only:
            ...
            weight[self.body_keypoint_idxs] = weight[self.body_keypoint_idxs] * body_weight
            weight[self.hand_keypoint_idxs] = weight[self.hand_keypoint_idxs] * hand_weight
            weight[self.face_keypoint_idxs] = weight[self.face_keypoint_idxs] * face_weight
