...
BACKBONES.register_module(name="PoseHighResolutionNet", module=PoseHighResolutionNet)
BACKBONES.register_module(name="PoseHighResolutionNetExpose", module=PoseHighResolutionNetExpose)
BACKBONES.register_module(name="PoseHighResolutionNetPyMAFX", module=PoseHighResolutionNetPyMAFX)
