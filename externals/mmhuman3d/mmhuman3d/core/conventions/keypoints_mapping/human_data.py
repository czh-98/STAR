...
HUMAN_DATA_SHOULDER = ["left_shoulder", "left_shoulder_openpose", "right_shoulder", "right_shoulder_openpose"]
...
HUMAN_DATA_LIMBS = {
    ...
    "face": [
        ["right_contour_1", "right_contour_2"],
    ...
    "right_eye": [
        ["right_eye_1", "right_eye_2"],
        ["right_eye_2", "right_eye_3"],
        ["right_eye_3", "right_eye_4"],
        ["right_eye_4", "right_eye_5"],
        ["right_eye_5", "right_eye_6"],
        ["right_eye_6", "right_eye_1"],
    ...
    "left_eye": [
        ["left_eye_4", "left_eye_3"],
        ["left_eye_3", "left_eye_2"],
        ["left_eye_2", "left_eye_1"],
        ["left_eye_1", "left_eye_6"],
        ["left_eye_6", "left_eye_5"],
        ["left_eye_5", "left_eye_4"],
    ...
    "mouth": [
        ["right_mouth_1", "right_mouth_2"],
        ["right_mouth_2", "right_mouth_3"],
        ["right_mouth_3", "mouth_top"],
        ["mouth_top", "left_mouth_3"],
        ["left_mouth_3", "left_mouth_2"],
        ["left_mouth_2", "left_mouth_1"],
        ["left_mouth_1", "left_mouth_5"],
        ["left_mouth_5", "left_mouth_4"],
        ["left_mouth_4", "mouth_bottom"],
        ["mouth_bottom", "right_mouth_4"],
        ["right_mouth_4", "right_mouth_5"],
        ["right_mouth_5", "right_mouth_1"],
        ["right_lip_1", "right_lip_2"],
        ["right_lip_2", "lip_top"],
        ["lip_top", "left_lip_2"],
        ["left_lip_2", "left_lip_1"],
        ["left_lip_1", "left_lip_3"],
        ["left_lip_3", "lip_bottom"],
        ["lip_bottom", "right_lip_3"],
        ["right_lip_3", "right_lip_1"],
    ],
    "nose": [
...
for k in HUMAN_DATA_LIMBS:
    HUMAN_DATA_LIMBS_INDEX[k] = [[HUMAN_DATA.index(limb[0]), HUMAN_DATA.index(limb[1])] for limb in HUMAN_DATA_LIMBS[k]]
