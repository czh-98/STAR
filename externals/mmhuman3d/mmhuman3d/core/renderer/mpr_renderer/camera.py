...
class Pinhole2D:
    ...
    def project_ndc(self, vertices, eps=1e-9):
        ...
        K = torch.tensor(self.get_K(), device=vertices.device, dtype=vertices.dtype)
        ...
        wh = torch.tensor([self.w, self.h], device=vertices.device, dtype=vertices.dtype).unsqueeze(0)
