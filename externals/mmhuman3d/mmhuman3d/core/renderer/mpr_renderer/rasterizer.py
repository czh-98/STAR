...
try:
    from mmhuman3d.core.renderer.mpr_renderer.cuda.rasterizer import (
        estimate_normals as estimate_normals_cuda,
    )  # noqa: E501
    from mmhuman3d.core.renderer.mpr_renderer.cuda.rasterizer import project_mesh as project_mesh_cuda  # noqa: E501
...
def estimate_normals(vertices, faces, pinhole, vertices_filter=None):
    ...
    coords, normals = estimate_normals_cuda(vertices_ndc, faces, vertices, vertices_filter, pinhole.h, pinhole.w)
...
def project_mesh(vertices, faces, vertice_values, pinhole, vertices_filter=None):
    ...
    vertices = vertices.contiguous()
    vertices_ndc = pinhole.project_ndc(vertices)
    return project_mesh_cuda(vertices_ndc, faces, vertice_values, vertices_filter, pinhole.h, pinhole.w)
