...
MMLIGHT_ATTR = ["ambient_color", "diffuse_color", "specular_color", "location", "direction"]
...
class AmbientLights(_AmbientLights, MMLights):
    ...
    def __init__(self, ambient_color=None, device="cpu", **kwargs) -> None:
        ...
        super(_AmbientLights, self).__init__(ambient_color=ambient_color, diffuse_color=diffuse_color, device=device)
