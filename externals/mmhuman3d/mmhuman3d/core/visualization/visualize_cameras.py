...
def visualize_chessboard_kinects_rgb(chessboard_path: str, interactive: bool = True, show: bool = True):
    ...
    for camera_id in camera_para_json_dict.keys():
        ...
        temp_camera_parameter.load_from_chessboard(camera_para_json_dict[camera_id], camera_id)
