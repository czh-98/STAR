...
def test_existence():
    ...
    check_path_existence("mmhuman3d/core", "file") == Existence.DirectoryExistNotEmpty
    check_path_existence("mmhuman3d/not_exist/", "file") == Existence.DirectoryNotExist
    check_path_existence("mmhuman3d/not_exist.txt", "auto") == Existence.FileNotExist
