...
test_image_path = "tests/data/dataset_sample/3DPW/imageFiles/" "courtyard_arguing_00/image_00000.jpg"
...
def test_get_bbox_inf():
    ...
    results = {"img": np.ones((224, 224, 3)), "center": np.array([100, 100]), "scale": np.array([10, 10])}
