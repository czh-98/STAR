...
def test_vis_kp3d():
    ...
    with pytest.raises(AssertionError):
        keypoints = np.random.randint(low=0, high=255, size=(133, 3), dtype=np.uint8)
        visualize_kp3d(
            keypoints,
    ...
    with pytest.raises(AssertionError):
        keypoints = np.random.randint(low=0, high=255, size=(5, 133, 1), dtype=np.uint8)
        visualize_kp3d(
            keypoints,
            "tests/data/test_vis_kp3d/tmp.mp4",
            mask=None,
    ...
    # wrong pop_parts
    with pytest.raises(AssertionError):
        keypoints = np.random.randint(low=0, high=255, size=(5, 133, 3), dtype=np.uint8)
        visualize_kp3d(
            keypoints,
            "tests/data/test_vis_kp3d/tmp.mp4",
            mask=None,
    ...
    with pytest.raises(FileNotFoundError):
        keypoints = np.random.randint(low=0, high=255, size=(1, 133, 3), dtype=np.uint8)
        visualize_kp3d(
            keypoints,
    ...
    visualize_kp3d(
        keypoints, output_path=None, mask=None, orbit_speed=0.5, resolution=(128, 128), data_source="coco_wholebody"
    )
    ...
    keypoints = np.random.randint(low=0, high=255, size=(5, 1, 133, 3), dtype=np.uint8)
    visualize_kp3d(
        keypoints,
    ...
    keypoints = np.random.randint(low=0, high=255, size=(5, 2, 133, 3), dtype=np.uint8)
    visualize_kp3d(
        keypoints,
    ...
    keypoints = np.random.randint(low=0, high=255, size=(5, 1, 133, 4), dtype=np.uint8)
    visualize_kp3d(
        keypoints,
    ...
    keypoints = np.random.randint(low=0, high=255, size=(5, 1, 17, 3), dtype=np.uint8)
    keypoints, mask = convert_kps(keypoints=keypoints, src="coco", dst="coco_wholebody")
...
def test_renderer():
    ...
    keypoints = np.random.randint(low=0, high=255, size=(110, 1, 18, 3), dtype=np.uint8)
    visualize_kp3d(
        keypoints,
