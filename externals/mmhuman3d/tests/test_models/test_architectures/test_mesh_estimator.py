...
def test_compute_keypoints3d_loss():
    model = ImageBodyModelEstimator(convention="smpl_54", loss_keypoints3d=dict(type="SmoothL1Loss", loss_weight=100))
...
def test_compute_keypoints2d_loss():
    model = ImageBodyModelEstimator(convention="smpl_54", loss_keypoints2d=dict(type="SmoothL1Loss", loss_weight=10))
...
def test_compute_vertex_loss():
    model = ImageBodyModelEstimator(convention="smpl_54", loss_vertex=dict(type="L1Loss", loss_weight=2))
...
def test_compute_smpl_pose_loss():
    model = ImageBodyModelEstimator(convention="smpl_54", loss_smpl_pose=dict(type="MSELoss", loss_weight=3))
...
def test_compute_smpl_betas_loss():
    model = ImageBodyModelEstimator(convention="smpl_54", loss_smpl_betas=dict(type="MSELoss", loss_weight=0.02))
...
def test_run_registration():
    ...
    model = ImageBodyModelEstimator(body_model_train=body_model, registration=registration)
