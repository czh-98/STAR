...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(type="Pretrained", checkpoint="data/checkpoints/resnet50_a1h2_176-001a1197.pth"),
    ),
...
adv_data_keys = ["smpl_body_pose", "smpl_global_orient", "smpl_betas", "smpl_transl"]
...
test_pipeline = [
    ...
    dict(
        type="Collect",
        keys=["img", *data_keys],
        meta_keys=["image_path", "center", "scale", "rotation", "img_h", "img_w", "bbox_info"],
    ),
]
