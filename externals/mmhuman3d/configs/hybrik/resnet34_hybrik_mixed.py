...
model = dict(
    ...
    head=dict(type="HybrIKHead", smpl_mean_params="data/body_models/h36m_mean_beta.npy"),
    body_model=dict(
        type="HybrIKSMPL",
...
train_pipeline = [
    ...
    dict(type="Collect", keys=["img", *data_keys], meta_keys=["center", "scale", "rotation", "image_path"]),
]
...
hp3d_idxs = [147, 146, 17, 19, 21, 16, 18, 20, 144, 5, 8, 145, 4, 7, 148, 150, 152]
hp3d_keypoints_map = [
    dict(keypoints=["keypoints3d", "keypoints3d_vis", "keypoints3d_relative"], keypoints_index=hp3d_idxs),
]
