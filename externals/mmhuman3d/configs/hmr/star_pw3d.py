...
# optimizer
optimizer = dict(backbone=dict(type="Adam", lr=2.5e-4), head=dict(type="Adam", lr=2.5e-4))
...
model = dict(
    ...
    body_model_test=dict(type="STAR", keypoint_src="smpl", keypoint_dst="star", model_path="data/body_models/star"),
    convention="star",
...
data = dict(
    ...
    val=dict(
        type=dataset_type,
        dataset_name="h36m",
        body_model=dict(type="STAR", keypoint_src="h36m", keypoint_dst="h36m", model_path="data/body_models/star"),
        data_prefix="data",
