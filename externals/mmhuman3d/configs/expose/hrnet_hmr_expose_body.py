...
model = dict(
    ...
    backbone=dict(
        ...
        extra=hrnet_extra,
        init_cfg=dict(type="Pretrained", checkpoint="data/pretrained_models/hrnet_pretrain.pth"),
    ),
    head=dict(
        type="ExPoseBodyHead",
        num_betas=10,
...
train_pipeline = [
    ...
    dict(type="Collect", keys=["img", *data_keys], meta_keys=["image_path", "center", "scale", "rotation", "ori_img"]),
]
test_pipeline = [
    dict(type="LoadImageFromFile"),
