...
model = dict(
    ...
    backbone=dict(
        type="ResNet", depth=18, init_cfg=dict(type="Pretrained", checkpoint="data/pretrained_models/resnet18.pth")
    ),
    head=dict(
        type="ExPoseHandHead",
        num_betas=10,
...
train_pipeline = [
    ...
    dict(type="RandomHorizontalFlip", flip_prob=0, convention="mano"),  # hand = 0,head = body = 0.5
