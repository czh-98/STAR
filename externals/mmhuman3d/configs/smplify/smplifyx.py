...
stages = [
    ...
    dict(
        ...
        fit_leye_pose=False,
        fit_reye_pose=False,
        joint_weights=dict(body_weight=5.0, use_shoulder_hip_only=True, hand_weight=0.0, face_weight=0.0),
    ),
    # stage 2
    dict(
        num_iter=5,
        ...
        fit_leye_pose=False,
        fit_reye_pose=False,
        joint_weights=dict(body_weight=5.0, use_shoulder_hip_only=False, hand_weight=0.0, face_weight=0.0),
    ),
    # stage 3
    dict(
        num_iter=3,
        ...
        fit_leye_pose=False,
        fit_reye_pose=False,
        joint_weights=dict(body_weight=10.0, use_shoulder_hip_only=False, hand_weight=1.0, face_weight=1.0),
    ),
]
