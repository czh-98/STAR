...
__mesh_model__ = dict(name="smplx", smpl_mean_params="data/body_models/smpl_mean_params.npz", gender="neutral")
...
data = dict(
    samples_per_gpu=48,
    workers_per_gpu=8,
    test=dict(type=dataset_type, data_prefix="data", pipeline=inference_pipeline, img_res=__img_res__, hf_img_size=224),
)
