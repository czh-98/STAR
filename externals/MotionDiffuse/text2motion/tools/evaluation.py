        ...
        with torch.no_grad():
            for idx, batch in enumerate(motion_loader):
                ...
                text_embeddings, motion_embeddings = eval_wrapper.get_co_embeddings(
                    word_embs=word_embeddings, pos_ohot=pos_one_hots, cap_lens=sent_lens, motions=motions, m_lens=m_lens
                )
...
if __name__ == "__main__":
    ...
    eval_motion_loaders = {
        "text2motion": lambda: get_motion_loader(opt, batch_size, trainer, gt_dataset, mm_num_samples, mm_num_repeats)
    }
