...
class BaseOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument(
            "--decomp_name", type=str, default="Decomp_SP001_SM001_H512", help="Name of autoencoder model"
        )
        ...
        self.parser.add_argument(
            "--unit_length", type=int, default=4, help="Motions are cropped to the maximum times of unit_length"
        )
        ...
        self.parser.add_argument(
            "--dim_text_hidden", type=int, default=512, help="Dimension of hidden unit in text encoder"
        )
        ...
        self.parser.add_argument(
            "--dim_pri_hidden", type=int, default=1024, help="Dimension of hidden unit in prior network"
        )
        self.parser.add_argument(
            "--dim_pos_hidden", type=int, default=1024, help="Dimension of hidden unit in posterior network"
        )
        self.parser.add_argument(
            "--dim_dec_hidden", type=int, default=1024, help="Dimension of hidden unit in generator"
        )

        self.parser.add_argument(
            "--dim_movement_enc_hidden", type=int, default=512, help="Dimension of hidden in AutoEncoder(encoder)"
        )
        self.parser.add_argument(
            "--dim_movement_dec_hidden", type=int, default=512, help="Dimension of hidden in AutoEncoder(decoder)"
        )
