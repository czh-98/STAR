...
class TestOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument(
            "--repeat_times", type=int, default=3, help="Number of generation rounds for each text description"
        )
        ...
        self.parser.add_argument(
            "--text_file", type=str, default="", help="Path of text description for motion generation"
        )
        self.parser.add_argument("--which_epoch", type=str, default="latest", help="Checkpoint that will be used")
        self.parser.add_argument(
            "--result_path", type=str, default="./eval_results/", help="Path to save generation results"
        )
