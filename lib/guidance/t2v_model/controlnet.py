...
class ControlNet3DModel(ModelMixin, ConfigMixin):
    ...
    def __init__(
        ...
        self.controlnet_cond_embedding = ControlNet3DConditioningEmbedding(  # TODO:
    ...
    def forward(
    ...
    ) -> Union[ControlNet3DOutput, Tuple]:
        # check channel order
        ...
        return ControlNet3DOutput(
            down_block_res_samples=down_block_res_samples,
            mid_block_res_sample=mid_block_res_sample,
        )

    @classmethod
    def from_pretrained_2d(cls, controlnet2d_model):
        config = controlnet2d_model.config
        ...
        print("controlnet unet from config")
        model = cls.from_config(config)

        state_dict = controlnet2d_model.state_dict()
