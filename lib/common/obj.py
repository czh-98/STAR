...
class Mesh:
    ...
    @classmethod
    def load_obj(
        cls, path, albedo_path=None, device=None, init_empty_tex=False, albedo_res=1024, uv_path=None, normalize=False
    ):
    ...
    def auto_uv_face_att(self):
        ...
        self.uv_face_att = kal.ops.mesh.index_vertices_by_faces(self.vt.unsqueeze(0), self.ft.long())
