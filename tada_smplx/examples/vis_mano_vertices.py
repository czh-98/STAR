...
def main(model_folder, corr_fname, ext="npz", hand_color=(0.3, 0.3, 0.6), gender="neutral", hand="right"):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--corr-fname", required=True, type=str, dest="corr_fname", help="Filename with the hand correspondences"
    )
    ...
    parser.add_argument(
        "--hand", default="right", choices=["right", "left", "both"], type=str, help="Which hand to plot"
    )
    parser.add_argument(
        "--hand-color",
        type=float,
    ...
    main(model_folder, corr_fname, ext=ext, hand_color=hand_color, gender=gender, hand=hand)
