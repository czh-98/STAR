...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--corr-fname", required=True, type=str, dest="corr_fname", help="Filename with the head correspondences"
    )
    ...
    parser.add_argument("--head", default="right", choices=["right", "left"], type=str, help="Which head to plot")
    parser.add_argument(
        "--head-color",
        type=float,
        nargs=3,
