...
def parse_args(argv=None) -> OmegaConf:
    ...
    parser.add_argument("--exp-cfg", type=str, dest="exp_cfg", help="The configuration of the experiment")
    parser.add_argument("--exp-opts", default=[], dest="exp_opts", nargs="*", help="Command line arguments")
